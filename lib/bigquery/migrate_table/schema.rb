  ...
  class MigrateTable
    class Schema < ::Array
      ...
      def initialize(columns = [])
        @columns = self.class.normalize_columns(columns)
        validate_columns!
        super(@columns)
      end
      ...
      def validate_columns!
        self.class.validate_columns!(@columns)
      end
      ...
      def normalize_columns
        self.class.normalize_columns(@columns)
      end

      def shallow_normalize_columns
        self.class.shallow_normalize_columns(@columns)
      end
      def shallow_normalize_columns!
        self.class.shallow_normalize_column!(@columns)
      end

      def flattened_columns
        self.class.flattened_columns(@columns)
      end

      # self - source_column
      def diff_columns(source_columns)
        self.class.diff_columns(source_columns, @columns)
      end

      def reverse_merge!(source_columns)
        self.class.reverse_merge!(source_columns, @columns)
      end

      def reject_columns!(drop_columns)
        self.class.reject_columns!(drop_columns, @columns)
      end

      def build_query_fields(source_columns)
        self.class.build_query_fields(source_columns, @columns)
      end
