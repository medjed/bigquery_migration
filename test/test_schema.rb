...
require 'bigquery/migrate_table/schema'

Schema = Bigquery::MigrateTable::Schema
  ...
  sub_test_case "diff_columns" do
    sub_test_case "without intersect" do
      ...
      def test_diff_columns_superset
        ...
        assert { Schema.diff_columns(expected, result).empty? }
      end
    end
    ...
    sub_test_case "with intersect" do
      ...
      def test_diff_columns_drop_columns
        ...
        assert { Schema.diff_columns(expected, drop_columns).empty? }
      end
      ...
      def test_diff_columns_add_columns
        ...
        assert { Schema.diff_columns(expected, add_columns).empty? }
      end
    end
  end
